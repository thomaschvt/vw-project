...
use VintageWest\AdminBundle\Form\NewsType;
...
class NewsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('VintageWestAdminBundle:News')->findAll();
     ...
     * @Method("POST")
     * @Template("VintageWestAdminBundle:News:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('VintageWestAdminBundle:News')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("VintageWestAdminBundle:News:edit.html.twig")
     */
