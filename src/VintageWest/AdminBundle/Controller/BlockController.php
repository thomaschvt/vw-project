...
use VintageWest\AdminBundle\Entity\Block;
use VintageWest\AdminBundle\Form\BlockType;
...
class BlockController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('VintageWestAdminBundle:Block')->findAll();
     ...
     * @Method("POST")
     * @Template("VintageWestAdminBundle:Block:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('VintageWestAdminBundle:Block')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("VintageWestAdminBundle:Block:edit.html.twig")
     */
